;
(function($) {　　
    function SubType(ele, options) {　　　　 this.$ele = ele;　　　　
    ...
    SubType.prototype = {　　　　
        createPopWin: function() {　　　　　　
            ...
            if (popWinDom) { //弹窗已创建
                　　　　　　　　
                popWinDom.css({　　　　　　　　　　 width: this.opts.width, 　　　　　　　　　　height: this.opts.height　　　　　　　　 }).attr('class', this.opts.winCssName);　　　　　　　　
                ...
                this.opts.btnArr.map(function(item, index) {　　　　　　　　　　 btnAreaDom.append($('<button></button>')　　　　　　　　　　　　.text(item)　　　　　　　　　　　　.attr('data-index', index)　　　　　　　　　　　　.attr('class', _this.opts.btnCssName)　　　　　　　　　　　　.on('click', function() {　　　　　　　　　　　　　　 _this.opts.callback($(this).attr('data-index'));　　　　　　　　　　　　　　
